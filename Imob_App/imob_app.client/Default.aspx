...
<div class="main">
	<header>
    	<div class="inner">
        	...
        	<a href="index.html" class="logo">ImobApp Processing</a>
        </div>
        <nav>
        	<ul class="sf-menu">
    	...
    	<div class="wrapper vr-separator-2">
        	<article class="grid_5 vr-separator-1">
            	<div class="top-box">
                    ...
                    <h4 class="head-1"><strong>Tudo</strong><b>Online</b></h4>
            ...
            <article class="grid_5 vr-separator-1">
            	<div class="top-box">
                    ...
                    <h4 class="head-1"><strong>Seguranca</strong><b>no Pagamento</b></h4>
                    <ul class="list-1 pad-left">
                    	<li><a href="more.html">Texto 1</a></li>
            ...
            <article class="grid_5 vr-separator-1">
            	<div class="top-box">
                    ...
                    <h4 class="head-1"><strong>Atendimento</strong><b>24 horas</b></h4>
                    <ul class="list-1 pad-left">
                    	<li><a href="more.html">Texto 1</a></li>
            ...
            <article class="grid_5 vr-separator-1">
            	<div class="top-box">
                    ...
                    <h4 class="head-1"><strong>Tudo no</strong><b>seu Celular</b></h4>
                    <ul class="list-1 pad-left">
                    	<li><a href="more.html">Texto 1</a></li>
